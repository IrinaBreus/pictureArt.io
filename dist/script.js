...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var state = Object(_calc__WEBPACK_IMPORTED_MODULE_7__["default"])();
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        document.querySelector('.calc .calc-price').textContent = 'Для расчета нужно выбрать размер картины и материал картины';
        setTimeout(function () {
...
var modals = function modals() {
  var scroll = Object(_scroll__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
var calcScroll = function calcScroll() {
  ...
  var scrollWith = div.offsetWidth - div.clientWidth;
  div.remove();
  return scrollWith;
};
